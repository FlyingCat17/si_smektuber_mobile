...
public class AdapterDataFasilitasExtra extends RecyclerView.Adapter<AdapterData.HolderData>{
    List<String> listData;
    LayoutInflater inflater;

    public AdapterDataFasilitasExtra(Context context, List<String> listData) {
